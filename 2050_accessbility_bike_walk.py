...
model_path = 'U:\\angela\job_housing\soundcast_2050'
output_path = 'U:\\angela\job_housing\soundcast_2050'
...
def main():
    ...
    new_parcel_df = pd.merge(newdf, parcel_df[['node_ids', 'HH_P', geo_boundry[geo]]], on="node_ids", copy=False)
    ...
    if geo != 'parcel':
        ...
        new_parcel_df_groupby = new_parcel_df
